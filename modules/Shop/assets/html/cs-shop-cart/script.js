...
(function(){
  ...
  GUEST_ID = 1;
  DEFAULT_IMAGE = '/modules/Shop/assets/img/no-image.svg';
  shop = cs.shop;
  cart = shop.cart;
  params = cart.params;
  Polymer({
    ...
    finish_order: function(){
      ...
      cs.api('post api/Shop/orders', data).then(function(result){
        ...
        if (this$.payment_method === 'shop:cash') {
          ...
          id = result.split('/').pop();
          modal = cs.ui.simple_modal("<h1 class=\"cs-text-center\">" + this$.L.thanks_for_order + "</h1>\n<p class=\"cs-text-center\">\n	<cs-button primary><button type=\"button\" class=\"pay-now\">" + this$.L.pay_now + "</button></cs-button>\n	<cs-button><button type=\"button\" class=\"pay-later\">" + this$.L.pay_later + "</button></cs-button>\n</p>");
