While [CleverStyle Widgets](/docs/CleverStyle-Widgets) provide set of elements, for some use cases using plain elements is a bit too low-level and simpler wrappers might be very useful.
