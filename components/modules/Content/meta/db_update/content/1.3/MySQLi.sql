ALTER TABLE `[prefix]content` DROP PRIMARY KEY, ADD PRIMARY KEY (`key`(191));
ALTER TABLE `[prefix]content` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
REPAIR TABLE `[prefix]content`;
OPTIMIZE TABLE `[prefix]content`;
