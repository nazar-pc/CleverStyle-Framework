...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#">
	...
	<script class="cs-config" target="cs" type="application/json">{"base_url":"http:\/\/cscms.travis","current_base_url":"http:\/\/cscms.travis\/System","public_key":"%s","module":"System","in_admin":0,"is_admin":0,"is_user":0,"is_guest":1,"debug":0,"cookie_prefix":"","cookie_domain":"cscms.travis","cookie_path":"\/","protocol":"http","route":[],"route_path":["blank"],"route_ids":[]}</script>
