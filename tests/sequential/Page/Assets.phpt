...
<script class="cs-config" target="requirejs.paths" type="application/json">{"System":"\/modules\/System\/assets\/js","system":"\/modules\/System\/assets\/js"}</script>
...
<script src="/assets/js/Polymer/a2.polymer-1.7.0+no-shady-dom.min.js?%s"></script>
