...
system(PHP_BINARY." distributive.phar.php -sn Web-site -su http://cscms.travis -dh 127.0.0.1 -dn travis -du postgres -dp \"\" -dr 'xyz_' -ae admin@cscms.travis -ap 1111 -de $_ENV[DB]");
?>
--CLEAN--
<?php
