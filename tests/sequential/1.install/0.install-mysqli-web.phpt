...
system(PHP_BINARY.' '.__DIR__.'/0.install-mysqli-web-0.php');
system(PHP_BINARY.' '.__DIR__.'/0.install-mysqli-web-1.php');
?>
--CLEAN--
<?php
...
<section><form method="post">
	<nav>
		<label is="cs-label-button">
			<input checked name="mode" onclick="var items = document.getElementsByClassName(&apos;expert&apos;);for (var i = 0; i &lt; items.length; i++) {items.item(i).style.display = this.value == &apos;0&apos; ? &apos;table-row&apos; : &apos;&apos;;}" type="radio" value="1"> <span>Regular user</span>
		</label>
		<label is="cs-label-button">
			<input name="mode" onclick="var items = document.getElementsByClassName(&apos;expert&apos;);for (var i = 0; i &lt; items.length; i++) {items.item(i).style.display = this.value == &apos;0&apos; ? &apos;table-row&apos; : &apos;&apos;;}" type="radio" value="0"> <span>Expert</span>
		</label>
	</nav>
	<table>
		<tr>
